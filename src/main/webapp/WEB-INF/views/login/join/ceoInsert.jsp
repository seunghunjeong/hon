...
<body>
	<div id="page">
		<div id="title">
			...
			<div>
				<div class="insertbox"
					style="margin-right: 120px; background-color: white; color: black"
					id="toggle">일반회원</div>

				<div class="insertbox"
					style="background-color: silver; color: white;">
					<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>점장회원
				</div>
			</div>
		</div>
			...
			<div>
				...
				<div class="box">
					...
					<br> <input type="radio" id="male" name="gender"
						style="margin: 0px 5px 0px 50px"><label for="male">남자</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" id="female"
						name="gender" style="margin: 0px 5px 0px 70px"><label
						for="female">여자</label>
				</div>
