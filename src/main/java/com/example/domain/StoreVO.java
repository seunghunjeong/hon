...
public class StoreVO {
	...
	public String toString() {
		return "StoreVO [sid=" + sid + ", sname=" + sname + ", location=" + location + ", phone=" + phone + ", simage="
				+ simage + ", favor=" + favor + ", reservation=" + reservation + ", weather=" + weather + ", yearS="
				+ yearS + ", lvs=" + lvs + ", priceS=" + priceS + ", OpeningT=" + OpeningT + ", RestT=" + RestT
				+ ", website=" + website + ", Ftype=" + Ftype + ", RestD=" + RestD + ", UpdateD=" + UpdateD + ", info="
				+ info + "]";
	}
}
